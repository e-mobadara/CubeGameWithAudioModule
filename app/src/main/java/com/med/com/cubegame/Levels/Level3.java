...
public class Level3 extends AppCompatActivity {
    ...
    private ImageView square,square2,square3,objectif,objectif2,objectif3;
    private DisplayMetrics metrics;
    private Chronometer chrono;
    private float x, y;
    private float  tab[][] = new float [3][2];
    ...
    private void init(){
        ...
        mContentView = findViewById(R.id.activity_level3);/* Needs Change when changing activity */
    ...
    public int isPressed(MotionEvent event){
        int squarePressed = 0;
        /* Calculating */
        float wSquare = square.getX() + square.getWidth();
        float hSquare = square.getY() + square.getHeight();
        float wSquare2 = square2.getX() + square2.getWidth();
        float hSquare2 = square2.getY() + square2.getHeight();
        float wSquare3 = square3.getX() + square3.getWidth();
        float hSquare3 = square3.getY() + square3.getHeight();
    ...
    private void setToFullScreen(){ /* Needs Change when changing activity */
        ViewGroup rootLayout = findViewById(R.id.activity_level3);

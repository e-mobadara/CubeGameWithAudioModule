...
public class Level2 extends AppCompatActivity {
    ...
    private ImageView square, square2, objectif, objectif2;
    private Chronometer chrono;
    private DisplayMetrics metrics;
    private float x, y;
    private float  tab[][] = new float [2][2];
    ...
    private void init(){
        ...
        mContentView = findViewById(R.id.activity_level2);/* Needs Change when changing activity */
    ...
    private void setToFullScreen(){ /* Needs Change when changing activity */
        ViewGroup rootLayout = findViewById(R.id.activity_level2);
